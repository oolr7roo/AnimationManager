...
public class Intermediate1_StateTransition : MonoBehaviour
{
    [Header("Refs")]
    ...
    private void Update()
    {
        ...
        if (isGrounded && Input.GetKeyDown(KeyCode.Space))
        {
            ...
            float normalizedStart = 0.25f;
            animator.CrossFade("Base Layer.jump", 0.1f, 0, normalizedStart);
        }
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift))
        {
            ...
            if (Time.time - lastRollTime < rollCd) return;
